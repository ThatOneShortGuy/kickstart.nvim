...
vim.keymap.set('i', 'j;', '<Esc>', { desc = 'Escape mode' })
...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { c = true, cpp = true, py = true, php = true }
  ...
  { 'folke/todo-comments.nvim', event = 'VimEnter', dependencies = { 'nvim-lua/plenary.nvim' }, opts = { signs = vim.g.have_nerd_font } },
